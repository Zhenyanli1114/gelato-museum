...
export default function ReviewForm({ onSubmit }: ReviewFormProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium mb-2" style={{ color: "var(--ink-light)" }}>
          Your Rating
        </label>
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          className="museum-input resize-none"
      ...
      <button type="submit" className="museum-btn-primary">
        Submit Review
      </button>
    </form>
  );
