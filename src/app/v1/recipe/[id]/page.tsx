...
export default function V1RecipePage() {
  ...
  if (!recipe) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/v1/browse" className="museum-btn-primary inline-block mt-4">Browse All Recipes</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Link href={`/v1/recipe/${id}/reviews`} className="museum-btn-primary flex items-center gap-2">★ Reviews</Link>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 p-6 rounded-2xl flex items-center justify-between flex-wrap gap-4"
        ...
        <Link href={`/v1/recipe/${id}/reviews`} className="museum-btn-primary">Write a Review →</Link>
      </div>
    </div>
  );
}
