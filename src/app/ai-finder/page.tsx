        ...
        <div>
          ...
          {resolvedResults.length === 0 ? (
            <div className="text-center py-16 rounded-2xl" style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border)" }}>
              ...
              <Link href="/browse" className="museum-btn-outline inline-block mt-6">Browse All Recipes</Link>
            </div>
          ) : (
                ...
                <article key={recipe.id} className="museum-card flex gap-5 p-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      <Link href={`/recipe/${recipe.id}`} className="museum-btn-primary text-xs py-1 px-3 flex-shrink-0">
                        View →
                      </Link>
                    </div>
