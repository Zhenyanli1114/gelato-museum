    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <section className="text-center mb-14">
        ...
        <p className="text-lg max-w-xl mx-auto leading-relaxed mb-8" style={{ color: "var(--ink-light)" }}>
          ...
          <Link href="/chef" className="underline underline-offset-2 transition-colors duration-150 hover:opacity-70" style={{ color: "var(--mint-dark)" }}>Fran&ccedil;ois</Link>
        </p>
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          ...
          <a href="/browse" className="text-sm font-medium" style={{ color: "var(--mint-dark)" }}>View all →</a>
        </div>
      ...
      <section className="mt-16 text-center py-12 rounded-3xl" style={{ backgroundColor: "var(--mint-light)", border: "1px solid var(--border-mint)" }}>
        ...
        <a href="/ai-finder" className="museum-btn-primary inline-block">Try the AI Finder →</a>
      </section>
    </div>
  );
}
