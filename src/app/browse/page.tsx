    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm" style={{ color: "var(--ink-muted)" }}>
          {filtered.length} of {recipes.length} gelato recipes
        </p>
      </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-end gap-2 mb-4">
            <button
              ...
              style={{
                backgroundColor: layout === "grid" ? "var(--mint-light)" : "transparent",
                color: layout === "grid" ? "var(--mint-dark)" : "var(--ink-muted)",
            ...
            <button
              ...
              className="p-2 rounded-lg transition-colors"
              style={{
                backgroundColor: layout === "list" ? "var(--mint-light)" : "transparent",
                color: layout === "list" ? "var(--mint-dark)" : "var(--ink-muted)",
                border: "1px solid var(--border)",
              }}
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20 rounded-2xl" style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border)" }}>
              ...
              <p className="text-sm mb-6" style={{ color: "var(--ink-muted)" }}>Try adjusting or clearing your filter selections.</p>
              <button
                type="button"
